...
//find special music info
   ...
   $simages = array();
   $ssinger = array();
   $sjazz = R::findAll('country','ORDER BY id DESC');
...
//load the templates
  ...
  $helloworld ="Country";
  $blues2 ='active'; 
  echo $twig->render('music.twig',  array('musickind'=>$helloworld, 'country'=>$blues2,'musicurl'=>$jurl,'picurl'=>$jimages,'songname'=>$jname,
