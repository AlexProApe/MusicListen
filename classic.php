...
//find special music info
   ...
   $simages = array();
   $ssinger = array();
   $sjazz = R::findAll('classic','ORDER BY id DESC');
...
//load the templates
  ...
  $helloworld = "Classic";
  $blues2 = 'active'; 
  echo $twig->render('music.twig',  array('musickind'=>$helloworld, 'classical'=>$blues2,'musicurl'=>$jurl,'picurl'=>$jimages,'songname'=>$jname,
