...
//find special music info
   ...
   $simages = array();
   $ssinger = array();
   $sjazz = R::findAll('blues','ORDER BY id DESC');
...
//load the templates
  ...
  $helloworld="Blues";
  $blues2='active'; 
  echo $twig->render('music.twig',  array('musickind'=>$helloworld, 'blues'=>$blues2,'musicurl'=>$jurl,'picurl'=>$jimages,'songname'=>$jname,
